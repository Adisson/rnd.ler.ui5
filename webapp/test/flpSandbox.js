					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Solicitud Rendiciones",
									"targetURL": "#rndlerui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rndlerui5-display": {
								"semanticObject": "rndlerui5",
								"action": "display",
								"description": "A Fiori application.",
								"title": "Liquidación de Entrega a Rendir",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									"applicationType": "SAPUI5",
									"additionalInformation": "SAPUI5.Component=rnd.ler.ui5",
									"url": sap.ui.require.toUrl("rnd/ler/ui5")
								}
							}
						}
					}
